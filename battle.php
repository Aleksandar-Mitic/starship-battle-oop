...
use Service\Container as Container;
use Service\BattleManager as BattleManager;
    ...
    <body>
        <div class="container">
            ...
            <div class="result-box center-block">
                ...
                <h3>Ship Health</h3>
                <dl class="dl-horizontal"><?php echo $ship1->getName(); ?></dl>
                <dl class="dl-horizontal"><?php echo $ship1->getStrength(); ?></dl>

                <dl class="dl-horizontal"><?php echo $ship2->getName(); ?></dl>
                <dl class="dl-horizontal"><?php echo $ship2->getStrength(); ?></dl>
